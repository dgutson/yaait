...
you start, so the user can redirect it. Productive stops here: the choice with the highest exit
cost, a version whose falsifier would be expensive to check late, and anything the design
constrained that the stack only just satisfies.
